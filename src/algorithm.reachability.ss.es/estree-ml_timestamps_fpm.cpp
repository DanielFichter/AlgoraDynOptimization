...
ESTreeMLTimeStampsFPM<reverseArcDirection, preferOlder>::ESTreeMLTimeStampsFPM(unsigned int requeueLimit, double maxAffectedRatio)
    : ESTreeMLTimeStampsFPM<reverseArcDirection, preferOlder>(std::make_pair(requeueLimit, maxAffectedRatio))
{
}

template<bool reverseArcDirection, bool preferOlder>
ESTreeMLTimeStampsFPM<reverseArcDirection, preferOlder>::ESTreeMLTimeStampsFPM(const ESTreeMLTimeStampsFPM<reverseArcDirection, preferOlder>::ParameterSet &params)
...
template<bool reverseArcDirection, bool preferOlder>
ESTreeMLTimeStampsFPM<reverseArcDirection, preferOlder>::~ESTreeMLTimeStampsFPM()
{
    cleanup(true);
}

template<bool reverseArcDirection, bool preferOlder>
void ESTreeMLTimeStampsFPM<reverseArcDirection, preferOlder>::setDyDiGraph(const DynamicDiGraph* newDyDiGraph)
{
    dyDiGraph = newDyDiGraph;
}

template<bool reverseArcDirection, bool preferOlder>
void ESTreeMLTimeStampsFPM<reverseArcDirection, preferOlder>::run()
{
    if (initialized) {
        return;
    }

   PRINT_DEBUG("Initializing ESTreeMLTimeStampsFPM...");
...
template<bool reverseArcDirection, bool preferOlder>
std::string ESTreeMLTimeStampsFPM<reverseArcDirection, preferOlder>::getProfilingInfo() const
{
    std::stringstream ss;
#ifdef COLLECT_PR_DATA
...
template<bool reverseArcDirection, bool preferOlder>
DynamicSingleSourceReachabilityAlgorithm::Profile ESTreeMLTimeStampsFPM<reverseArcDirection, preferOlder>::getProfile() const
{
...
template<bool reverseArcDirection, bool preferOlder>
void ESTreeMLTimeStampsFPM<reverseArcDirection, preferOlder>::onDiGraphSet()
{
...
template<bool reverseArcDirection, bool preferOlder>
void ESTreeMLTimeStampsFPM<reverseArcDirection, preferOlder>::onDiGraphUnset()
{
...
template<bool reverseArcDirection, bool preferOlder>
void ESTreeMLTimeStampsFPM<reverseArcDirection, preferOlder>::onVertexAdd(Vertex *v)
{
    if (!initialized) {
        return;
    }
...
template<bool reverseArcDirection, bool preferOlder>
void ESTreeMLTimeStampsFPM<reverseArcDirection, preferOlder>::onArcAdd(Arc *a)
{
    if (!initialized) {
        return;
    }
...
template<bool reverseArcDirection, bool preferOlder>
void ESTreeMLTimeStampsFPM<reverseArcDirection, preferOlder>::onVertexRemove(Vertex *v)
{
    if (!initialized) {
        return;
    }
...
template<bool reverseArcDirection, bool preferOlder>
void ESTreeMLTimeStampsFPM<reverseArcDirection, preferOlder>::onArcRemove(Arc *a)
{
   if (!initialized) {
        return;
    }
...
template<bool reverseArcDirection, bool preferOlder>
void ESTreeMLTimeStampsFPM<reverseArcDirection, preferOlder>::onSourceSet()
{
    cleanup(false);
}

template<bool reverseArcDirection, bool preferOlder>
bool ESTreeMLTimeStampsFPM<reverseArcDirection, preferOlder>::query(const Vertex *t)
{
    if (t == source) {
        return true;
    }
...
template<bool reverseArcDirection, bool preferOlder>
std::vector<Arc *> ESTreeMLTimeStampsFPM<reverseArcDirection, preferOlder>::queryPath(const Vertex *t)
{
    std::vector<Arc*> path;
    if (!query(t) || t == source) {
        return path;
...
template<bool reverseArcDirection, bool preferOlder>
void ESTreeMLTimeStampsFPM<reverseArcDirection, preferOlder>::dumpData(std::ostream &os) const
{
    if (!initialized) {
...
template<bool reverseArcDirection, bool preferOlder>
void ESTreeMLTimeStampsFPM<reverseArcDirection, preferOlder>::dumpTree(std::ostream &os)
{
    if (!initialized) {
        os << "uninitialized" << std::endl;
    }  else {
...
template<bool reverseArcDirection, bool preferOlder>
bool ESTreeMLTimeStampsFPM<reverseArcDirection, preferOlder>::checkTree()
{
...
template<bool reverseArcDirection, bool preferOlder>
void ESTreeMLTimeStampsFPM<reverseArcDirection, preferOlder>::rerun()
{
#ifdef COLLECT_PR_DATA
    reruns++;
#endif
...
template<bool reverseArcDirection, bool preferOlder>
DiGraph::size_type ESTreeMLTimeStampsFPM<reverseArcDirection, preferOlder>::process(ESVertexData *vd, bool &limitReached)
{
    if (vd->getLevel() == 0ULL) {
...
template<bool reverseArcDirection, bool preferOlder>
void ESTreeMLTimeStampsFPM<reverseArcDirection, preferOlder>::restoreTree(ESVertexData *rd)
{
    auto n = diGraph->getSize();
...
template<bool reverseArcDirection, bool preferOlder>
void ESTreeMLTimeStampsFPM<reverseArcDirection, preferOlder>::cleanup(bool freeSpace)
{
    if (initialized) {
        for (auto i = data.cbegin(); i != data.cend(); i++) {
            if ((*i)) {
...
template class ESTreeMLTimeStampsFPM<false, false>;
template class ESTreeMLTimeStampsFPM<false, true>;
template class ESTreeMLTimeStampsFPM<true, false>;
template class ESTreeMLTimeStampsFPM<true, true>;
}
