...
#include "simpleestree_timestamps_fpm.h"
...
SimpleESTreeTimeStampsFPM<reverseArcDirection, preferOlder>::SimpleESTreeTimeStampsFPM(unsigned int requeueLimit, double maxAffectedRatio)
    : SimpleESTreeTimeStampsFPM<reverseArcDirection, preferOlder>(std::make_pair(requeueLimit, maxAffectedRatio))
{ }

template<bool reverseArcDirection, bool preferOlder>
SimpleESTreeTimeStampsFPM<reverseArcDirection, preferOlder>::SimpleESTreeTimeStampsFPM(const SimpleESTreeTimeStampsFPM<reverseArcDirection, preferOlder>::ParameterSet &params)
...
template<bool reverseArcDirection, bool preferOlder>
SimpleESTreeTimeStampsFPM<reverseArcDirection, preferOlder>::~SimpleESTreeTimeStampsFPM()
{
    cleanup(true);
}

template<bool reverseArcDirection, bool preferOlder>
DiGraph::size_type SimpleESTreeTimeStampsFPM<reverseArcDirection, preferOlder>::getDepthOfBFSTree() const
{
...
template<bool reverseArcDirection, bool preferOlder>
DiGraph::size_type SimpleESTreeTimeStampsFPM<reverseArcDirection, preferOlder>::getNumReachable() const
{
...
template<bool reverseArcDirection, bool preferOlder>
void SimpleESTreeTimeStampsFPM<reverseArcDirection, preferOlder>::setDyDiGraph(const DynamicDiGraph* newDyDiGraph)
{
    dyDiGraph = newDyDiGraph;
}

template<bool reverseArcDirection, bool preferOlder>
void SimpleESTreeTimeStampsFPM<reverseArcDirection, preferOlder>::run()
{
    if (initialized) {
        return;
    }

    PRINT_DEBUG("Initializing SimpleESTreeTimeStampsFPM...");
...
template<bool reverseArcDirection, bool preferOlder>
std::string SimpleESTreeTimeStampsFPM<reverseArcDirection, preferOlder>::getProfilingInfo() const
{
    std::stringstream ss;
#ifdef COLLECT_PR_DATA
...
template<bool reverseArcDirection, bool preferOlder>
DynamicSingleSourceReachabilityAlgorithm::Profile SimpleESTreeTimeStampsFPM<reverseArcDirection, preferOlder>::getProfile() const
{
...
template<bool reverseArcDirection, bool preferOlder>
void SimpleESTreeTimeStampsFPM<reverseArcDirection, preferOlder>::onDiGraphSet()
{
...
template<bool reverseArcDirection, bool preferOlder>
void SimpleESTreeTimeStampsFPM<reverseArcDirection, preferOlder>::onDiGraphUnset()
{
...
template<bool reverseArcDirection, bool preferOlder>
void SimpleESTreeTimeStampsFPM<reverseArcDirection, preferOlder>::onVertexAdd(Vertex *v)
{
    if (!initialized) {
        return;
    }
...
template<bool reverseArcDirection, bool preferOlder>
void SimpleESTreeTimeStampsFPM<reverseArcDirection, preferOlder>::onArcAdd(Arc *a)
{
    if (!initialized) {
        return;
    }
...
template<bool reverseArcDirection, bool preferOlder>
void SimpleESTreeTimeStampsFPM<reverseArcDirection, preferOlder>::onVertexRemove(Vertex *v)
{
    if (!initialized) {
        return;
    }
...
template<bool reverseArcDirection, bool preferOlder>
void SimpleESTreeTimeStampsFPM<reverseArcDirection, preferOlder>::onArcRemove(Arc *a)
{
   if (!initialized) {
        return;
    }
...
template<bool reverseArcDirection, bool preferOlder>
void SimpleESTreeTimeStampsFPM<reverseArcDirection, preferOlder>::onSourceSet()
{
    cleanup(false);
}

template<bool reverseArcDirection, bool preferOlder>
bool SimpleESTreeTimeStampsFPM<reverseArcDirection, preferOlder>::query(const Vertex *t)
{
...
template<bool reverseArcDirection, bool preferOlder>
std::vector<Arc *> SimpleESTreeTimeStampsFPM<reverseArcDirection, preferOlder>::queryPath(const Vertex *t)
{
    std::vector<Arc*> path;
    if (!query(t) || t == source) {
        return path;
...
template<bool reverseArcDirection, bool preferOlder>
void SimpleESTreeTimeStampsFPM<reverseArcDirection, preferOlder>::dumpData(std::ostream &os) const
{
    if (!initialized) {
...
template<bool reverseArcDirection, bool preferOlder>
void SimpleESTreeTimeStampsFPM<reverseArcDirection, preferOlder>::dumpTree(std::ostream &os)
{
    if (!initialized) {
        os << "uninitialized" << std::endl;
    }  else {
...
template<bool reverseArcDirection, bool preferOlder>
bool SimpleESTreeTimeStampsFPM<reverseArcDirection, preferOlder>::checkTree()
{
...
template<bool reverseArcDirection, bool preferOlder>
void SimpleESTreeTimeStampsFPM<reverseArcDirection, preferOlder>::rerun()
{
#ifdef COLLECT_PR_DATA
    reruns++;
#endif
...
template<bool reverseArcDirection, bool preferOlder>
DiGraph::size_type SimpleESTreeTimeStampsFPM<reverseArcDirection, preferOlder>::process(SESVertexData *vd, bool &limitReached) {
...
template<bool reverseArcDirection, bool preferOlder>
void SimpleESTreeTimeStampsFPM<reverseArcDirection, preferOlder>::restoreTree(SESVertexData *rd)
{
    auto n = diGraph->getSize();
...
template<bool reverseArcDirection, bool preferOlder>
void SimpleESTreeTimeStampsFPM<reverseArcDirection, preferOlder>::cleanup(bool freeSpace)
{
    if (initialized) {
        for (auto i = data.cbegin(); i != data.cend(); i++) {
            if ((*i)) {
