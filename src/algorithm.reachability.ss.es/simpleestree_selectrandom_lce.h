...
#ifndef SIMPLEESTREESELECTRANDOMLCE_H
#define SIMPLEESTREESELECTRANDOMLCE_H
...
class SimpleESTreeSelectRandomLCE : public DynamicSingleSourceReachabilityAlgorithm
{
public:
...
private:
    ...
    std::minstd_rand generateRandomNumber;
