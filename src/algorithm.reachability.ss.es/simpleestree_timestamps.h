...
public:
    ...
    explicit SimpleESTreeTimeStamps(unsigned int requeueLimit = 5, double maxAffectedRatio = .5);
    explicit SimpleESTreeTimeStamps(const ParameterSet &params);
    virtual ~SimpleESTreeTimeStamps() override;
