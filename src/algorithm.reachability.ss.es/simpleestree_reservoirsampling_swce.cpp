...
namespace Algora
{
    ...
    SimpleESTreeReservoirSamplingSWCE<reverseArcDirection>::SimpleESTreeReservoirSamplingSWCE(unsigned int requeueLimit, double maxAffectedRatio)
        : SimpleESTreeReservoirSamplingSWCE<reverseArcDirection>(std::make_pair(requeueLimit, maxAffectedRatio))
    {
    }

    template <bool reverseArcDirection>
    SimpleESTreeReservoirSamplingSWCE<reverseArcDirection>::SimpleESTreeReservoirSamplingSWCE(const SimpleESTreeReservoirSamplingSWCE<reverseArcDirection>::ParameterSet &params)
    ...
    template <bool reverseArcDirection>
    SimpleESTreeReservoirSamplingSWCE<reverseArcDirection>::~SimpleESTreeReservoirSamplingSWCE()
    {
        cleanup(true);
    }

    template <bool reverseArcDirection>
    DiGraph::size_type SimpleESTreeReservoirSamplingSWCE<reverseArcDirection>::getDepthOfBFSTree() const
    {
    ...
    template <bool reverseArcDirection>
    DiGraph::size_type SimpleESTreeReservoirSamplingSWCE<reverseArcDirection>::getNumReachable() const
    {
    ...
    template <bool reverseArcDirection>
    void SimpleESTreeReservoirSamplingSWCE<reverseArcDirection>::run()
    {
        if (initialized)
        {
            return;
        ...
        PRINT_DEBUG("Initializing SimpleESTreeReservoirSamplingSWCE...");
    ...
    template <bool reverseArcDirection>
    std::string SimpleESTreeReservoirSamplingSWCE<reverseArcDirection>::getProfilingInfo() const
    {
        std::stringstream ss;
#ifdef COLLECT_PR_DATA
    ...
    template <bool reverseArcDirection>
    DynamicSingleSourceReachabilityAlgorithm::Profile SimpleESTreeReservoirSamplingSWCE<reverseArcDirection>::getProfile() const
    {
    ...
    template <bool reverseArcDirection>
    void SimpleESTreeReservoirSamplingSWCE<reverseArcDirection>::onDiGraphSet()
    {
    ...
    template <bool reverseArcDirection>
    void SimpleESTreeReservoirSamplingSWCE<reverseArcDirection>::onDiGraphUnset()
    {
    ...
    template <bool reverseArcDirection>
    void SimpleESTreeReservoirSamplingSWCE<reverseArcDirection>::onVertexAdd(Vertex *v)
    {
        if (!initialized)
        {
            return;
    ...
    template <bool reverseArcDirection>
    void SimpleESTreeReservoirSamplingSWCE<reverseArcDirection>::onArcAdd(Arc *a)
    {
        if (!initialized)
        {
            return;
    ...
    template <bool reverseArcDirection>
    void SimpleESTreeReservoirSamplingSWCE<reverseArcDirection>::onVertexRemove(Vertex *v)
    {
        if (!initialized)
        {
            return;
    ...
    template <bool reverseArcDirection>
    void SimpleESTreeReservoirSamplingSWCE<reverseArcDirection>::onArcRemove(Arc *a)
    {
        if (!initialized)
        {
            return;
    ...
    template <bool reverseArcDirection>
    void SimpleESTreeReservoirSamplingSWCE<reverseArcDirection>::onSourceSet()
    {
        cleanup(false);
    }

    template <bool reverseArcDirection>
    bool SimpleESTreeReservoirSamplingSWCE<reverseArcDirection>::query(const Vertex *t)
    {
    ...
    template <bool reverseArcDirection>
    std::vector<Arc *> SimpleESTreeReservoirSamplingSWCE<reverseArcDirection>::queryPath(const Vertex *t)
    {
        std::vector<Arc *> path;
        if (!query(t) || t == source)
        {
    ...
    template <bool reverseArcDirection>
    void SimpleESTreeReservoirSamplingSWCE<reverseArcDirection>::dumpData(std::ostream &os) const
    {
        if (!initialized)
        {
    ...
    template <bool reverseArcDirection>
    void SimpleESTreeReservoirSamplingSWCE<reverseArcDirection>::dumpTree(std::ostream &os)
    {
        if (!initialized)
        {
            os << "uninitialized" << std::endl;
    ...
    template <bool reverseArcDirection>
    bool SimpleESTreeReservoirSamplingSWCE<reverseArcDirection>::checkTree()
    {
    ...
    template <bool reverseArcDirection>
    void SimpleESTreeReservoirSamplingSWCE<reverseArcDirection>::rerun()
    {
#ifdef COLLECT_PR_DATA
        reruns++;
#endif
    ...
    template <bool reverseArcDirection>
    DiGraph::size_type SimpleESTreeReservoirSamplingSWCE<reverseArcDirection>::process(SESVertexData *vd, bool &limitReached)
    {
        ...
        // --- begin different from regular ESTree ---
        ...
        std::tie(treeArc, parent) = sampler.sample();
        sampler.reset();

        // --- end different from SimpleESTree ---
    ...
    template <bool reverseArcDirection>
    void SimpleESTreeReservoirSamplingSWCE<reverseArcDirection>::restoreTree(SESVertexData *rd)
    {
        auto n = diGraph->getSize();
    ...
    template <bool reverseArcDirection>
    void SimpleESTreeReservoirSamplingSWCE<reverseArcDirection>::cleanup(bool freeSpace)
    {
        if (initialized)
        {
            for (auto i = data.cbegin(); i != data.cend(); i++)
    ...
    template class SimpleESTreeReservoirSamplingSWCE<false>;
    template class SimpleESTreeReservoirSamplingSWCE<true>;
}
