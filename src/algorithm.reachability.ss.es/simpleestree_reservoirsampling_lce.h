...
#ifndef SIMPLEESTREERESERVOIRSAMPLINGLCE_H
#define SIMPLEESTREERESERVOIRSAMPLINGLCE_H
...
namespace Algora
{
    ...
    class SimpleESTreeReservoirSamplingLCE : public DynamicSingleSourceReachabilityAlgorithm
    {
    public:
        // requeueLimit, maxAffectedRatio
        typedef std::tuple<unsigned int, double> ParameterSet;

        explicit SimpleESTreeReservoirSamplingLCE(unsigned int requeueLimit = 5, double maxAffectedRatio = .5);
        explicit SimpleESTreeReservoirSamplingLCE(const ParameterSet &params);
        virtual ~SimpleESTreeReservoirSamplingLCE() override;
    ...
    private:
        ...
        ReservoirSampler<std::minstd_rand> sampler;
        PriorityQueue queue;
    ...
    extern template class SimpleESTreeReservoirSamplingLCE<false>;
    extern template class SimpleESTreeReservoirSamplingLCE<true>;
}

#endif // SIMPLEESTREERESERVOIRSAMPLINGLCE_H
