...
#include "simpleestree_selectrandom_swce.h"
...
SimpleESTreeSelectRandomSWCE<reverseArcDirection>::SimpleESTreeSelectRandomSWCE(unsigned int requeueLimit, double maxAffectedRatio)
    : SimpleESTreeSelectRandomSWCE<reverseArcDirection>(std::make_pair(requeueLimit, maxAffectedRatio))
{ }

template<bool reverseArcDirection>
SimpleESTreeSelectRandomSWCE<reverseArcDirection>::SimpleESTreeSelectRandomSWCE(const SimpleESTreeSelectRandomSWCE<reverseArcDirection>::ParameterSet &params)
...
template<bool reverseArcDirection>
SimpleESTreeSelectRandomSWCE<reverseArcDirection>::~SimpleESTreeSelectRandomSWCE()
{
    cleanup(true);
}

template<bool reverseArcDirection>
DiGraph::size_type SimpleESTreeSelectRandomSWCE<reverseArcDirection>::getDepthOfBFSTree() const
{
...
template<bool reverseArcDirection>
DiGraph::size_type SimpleESTreeSelectRandomSWCE<reverseArcDirection>::getNumReachable() const
{
...
template<bool reverseArcDirection>
void SimpleESTreeSelectRandomSWCE<reverseArcDirection>::run()
{
    if (initialized) {
        return;
    }

    PRINT_DEBUG("Initializing SimpleESTreeSelectRandomSWCE...");
...
template<bool reverseArcDirection>
std::string SimpleESTreeSelectRandomSWCE<reverseArcDirection>::getProfilingInfo() const
{
    std::stringstream ss;
#ifdef COLLECT_PR_DATA
...
template<bool reverseArcDirection>
DynamicSingleSourceReachabilityAlgorithm::Profile SimpleESTreeSelectRandomSWCE<reverseArcDirection>::getProfile() const
{
...
template<bool reverseArcDirection>
void SimpleESTreeSelectRandomSWCE<reverseArcDirection>::onDiGraphSet()
{
...
template<bool reverseArcDirection>
void SimpleESTreeSelectRandomSWCE<reverseArcDirection>::onDiGraphUnset()
{
...
template<bool reverseArcDirection>
void SimpleESTreeSelectRandomSWCE<reverseArcDirection>::onVertexAdd(Vertex *v)
{
    if (!initialized) {
        return;
    }
...
template<bool reverseArcDirection>
void SimpleESTreeSelectRandomSWCE<reverseArcDirection>::onArcAdd(Arc *a)
{
    if (!initialized) {
        return;
    }
...
template<bool reverseArcDirection>
void SimpleESTreeSelectRandomSWCE<reverseArcDirection>::onVertexRemove(Vertex *v)
{
    if (!initialized) {
        return;
    }
...
template<bool reverseArcDirection>
void SimpleESTreeSelectRandomSWCE<reverseArcDirection>::onArcRemove(Arc *a)
{
   if (!initialized) {
        return;
    }
...
template<bool reverseArcDirection>
void SimpleESTreeSelectRandomSWCE<reverseArcDirection>::onSourceSet()
{
    cleanup(false);
}

template<bool reverseArcDirection>
bool SimpleESTreeSelectRandomSWCE<reverseArcDirection>::query(const Vertex *t)
{
...
template<bool reverseArcDirection>
std::vector<Arc *> SimpleESTreeSelectRandomSWCE<reverseArcDirection>::queryPath(const Vertex *t)
{
    std::vector<Arc*> path;
    if (!query(t) || t == source) {
        return path;
...
template<bool reverseArcDirection>
void SimpleESTreeSelectRandomSWCE<reverseArcDirection>::dumpData(std::ostream &os) const
{
    if (!initialized) {
...
template<bool reverseArcDirection>
void SimpleESTreeSelectRandomSWCE<reverseArcDirection>::dumpTree(std::ostream &os)
{
    if (!initialized) {
        os << "uninitialized" << std::endl;
    }  else {
...
template<bool reverseArcDirection>
bool SimpleESTreeSelectRandomSWCE<reverseArcDirection>::checkTree()
{
...
template<bool reverseArcDirection>
void SimpleESTreeSelectRandomSWCE<reverseArcDirection>::rerun()
{
#ifdef COLLECT_PR_DATA
    reruns++;
#endif
...
template<bool reverseArcDirection>
DiGraph::size_type SimpleESTreeSelectRandomSWCE<reverseArcDirection>::process(SESVertexData *vd, bool &limitReached) {
...
template<bool reverseArcDirection>
void SimpleESTreeSelectRandomSWCE<reverseArcDirection>::restoreTree(SESVertexData *rd)
{
    auto n = diGraph->getSize();
...
template<bool reverseArcDirection>
void SimpleESTreeSelectRandomSWCE<reverseArcDirection>::cleanup(bool freeSpace)
{
    if (initialized) {
        for (auto i = data.cbegin(); i != data.cend(); i++) {
            if ((*i)) {
...
template<bool reverseArcDirection>
std::pair<Arc*, SESVertexData*> SimpleESTreeSelectRandomSWCE<reverseArcDirection>::selectRandomTreeArc(const ArcPool& potentialTreeArcs)
{
    const size_t arcIndex = generateRandomNumber() % potentialTreeArcs.size();
    return potentialTreeArcs.at(arcIndex);
}

template class SimpleESTreeSelectRandomSWCE<false>;
template class SimpleESTreeSelectRandomSWCE<true>;
}