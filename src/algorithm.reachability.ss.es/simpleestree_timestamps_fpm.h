...
#ifndef SIMPLEESTREETIMESTAMPSFPM_H
#define SIMPLEESTREETIMESTAMPSFPM_H
...
class SimpleESTreeTimeStampsFPM : public DynamicSingleSourceReachabilityAlgorithm
{
public:
    // requeueLimit, maxAffectedRatio
    typedef std::tuple<unsigned int, double> ParameterSet;

    explicit SimpleESTreeTimeStampsFPM(unsigned int requeueLimit = 5, double maxAffectedRatio = .5);
    explicit SimpleESTreeTimeStampsFPM(const ParameterSet &params);
    virtual ~SimpleESTreeTimeStampsFPM() override;
...
extern template class SimpleESTreeTimeStampsFPM<false, false>;
extern template class SimpleESTreeTimeStampsFPM<false, true>;
extern template class SimpleESTreeTimeStampsFPM<true, false>;
extern template class SimpleESTreeTimeStampsFPM<true, true>;
}

#endif // SimpleESTreeTimeStampsFPMTIMESTAMPSFPM_H
