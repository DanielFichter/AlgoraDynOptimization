...
#ifndef SimpleESTreeSelectRandomMTE_H
#define SimpleESTreeSelectRandomMTE_H
...
class SimpleESTreeSelectRandomMTE : public DynamicSingleSourceReachabilityAlgorithm
{
public:
    // requeueLimit, maxAffectedRatio
    typedef std::tuple<unsigned int, double> ParameterSet;

    explicit SimpleESTreeSelectRandomMTE(unsigned int requeueLimit = 5, double maxAffectedRatio = .5);
    explicit SimpleESTreeSelectRandomMTE(const ParameterSet &params);
    virtual ~SimpleESTreeSelectRandomMTE() override;
...
#endif // SimpleESTreeSelectRandomMTE_H
