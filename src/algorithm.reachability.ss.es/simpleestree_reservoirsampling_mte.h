...
#ifndef SIMPLEESTREERESERVOIRSAMPLINGMTE_H
#define SIMPLEESTREERESERVOIRSAMPLINGMTE_H
...
namespace Algora
{
    ...
    class SimpleESTreeReservoirSamplingMTE : public DynamicSingleSourceReachabilityAlgorithm
    {
    public:
        // requeueLimit, maxAffectedRatio
        typedef std::tuple<unsigned int, double> ParameterSet;

        explicit SimpleESTreeReservoirSamplingMTE(unsigned int requeueLimit = 5, double maxAffectedRatio = .5);
        explicit SimpleESTreeReservoirSamplingMTE(const ParameterSet &params);
        virtual ~SimpleESTreeReservoirSamplingMTE() override;
    ...
    private:
        ...
        ReservoirSampler<std::mt19937> sampler;
        PriorityQueue queue;
    ...
    extern template class SimpleESTreeReservoirSamplingMTE<false>;
    extern template class SimpleESTreeReservoirSamplingMTE<true>;
}

#endif // SIMPLEESTREERESERVOIRSAMPLINGMTE_H
