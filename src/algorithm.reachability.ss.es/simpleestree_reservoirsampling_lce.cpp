...
#include "simpleestree_reservoirsampling_lce.h"
...
namespace Algora
{
    ...
    SimpleESTreeReservoirSamplingLCE<reverseArcDirection>::SimpleESTreeReservoirSamplingLCE(unsigned int requeueLimit, double maxAffectedRatio)
        : SimpleESTreeReservoirSamplingLCE<reverseArcDirection>(std::make_pair(requeueLimit, maxAffectedRatio))
    {
    }

    template <bool reverseArcDirection>
    SimpleESTreeReservoirSamplingLCE<reverseArcDirection>::SimpleESTreeReservoirSamplingLCE(const SimpleESTreeReservoirSamplingLCE<reverseArcDirection>::ParameterSet &params)
    ...
    template <bool reverseArcDirection>
    DiGraph::size_type SimpleESTreeReservoirSamplingLCE<reverseArcDirection>::getDepthOfBFSTree() const
    {
    ...
    template <bool reverseArcDirection>
    DiGraph::size_type SimpleESTreeReservoirSamplingLCE<reverseArcDirection>::getNumReachable() const
    {
    ...
    template <bool reverseArcDirection>
    void SimpleESTreeReservoirSamplingLCE<reverseArcDirection>::run()
    {
        if (initialized)
        {
            return;
        ...
        PRINT_DEBUG("Initializing SimpleESTreeReservoirSamplingLCE...");
    ...
    template <bool reverseArcDirection>
    std::string SimpleESTreeReservoirSamplingLCE<reverseArcDirection>::getProfilingInfo() const
    {
        std::stringstream ss;
#ifdef COLLECT_PR_DATA
    ...
    template <bool reverseArcDirection>
    DynamicSingleSourceReachabilityAlgorithm::Profile SimpleESTreeReservoirSamplingLCE<reverseArcDirection>::getProfile() const
    {
    ...
    template <bool reverseArcDirection>
    void SimpleESTreeReservoirSamplingLCE<reverseArcDirection>::onDiGraphSet()
    {
    ...
    template <bool reverseArcDirection>
    void SimpleESTreeReservoirSamplingLCE<reverseArcDirection>::onDiGraphUnset()
    {
    ...
    template <bool reverseArcDirection>
    void SimpleESTreeReservoirSamplingLCE<reverseArcDirection>::onVertexAdd(Vertex *v)
    {
        if (!initialized)
        {
            return;
    ...
    template <bool reverseArcDirection>
    void SimpleESTreeReservoirSamplingLCE<reverseArcDirection>::onArcAdd(Arc *a)
    {
        if (!initialized)
        {
            return;
    ...
    template <bool reverseArcDirection>
    void SimpleESTreeReservoirSamplingLCE<reverseArcDirection>::onVertexRemove(Vertex *v)
    {
        if (!initialized)
        {
            return;
    ...
    template <bool reverseArcDirection>
    void SimpleESTreeReservoirSamplingLCE<reverseArcDirection>::onArcRemove(Arc *a)
    {
        if (!initialized)
        {
            return;
    ...
    template <bool reverseArcDirection>
    void SimpleESTreeReservoirSamplingLCE<reverseArcDirection>::onSourceSet()
    {
        cleanup(false);
    }

    template <bool reverseArcDirection>
    bool SimpleESTreeReservoirSamplingLCE<reverseArcDirection>::query(const Vertex *t)
    {
    ...
    template <bool reverseArcDirection>
    std::vector<Arc *> SimpleESTreeReservoirSamplingLCE<reverseArcDirection>::queryPath(const Vertex *t)
    {
        std::vector<Arc *> path;
        if (!query(t) || t == source)
        {
    ...
    template <bool reverseArcDirection>
    void SimpleESTreeReservoirSamplingLCE<reverseArcDirection>::dumpData(std::ostream &os) const
    {
        if (!initialized)
        {
    ...
    template <bool reverseArcDirection>
    void SimpleESTreeReservoirSamplingLCE<reverseArcDirection>::dumpTree(std::ostream &os)
    {
        if (!initialized)
        {
            os << "uninitialized" << std::endl;
    ...
    template <bool reverseArcDirection>
    bool SimpleESTreeReservoirSamplingLCE<reverseArcDirection>::checkTree()
    {
    ...
    template <bool reverseArcDirection>
    void SimpleESTreeReservoirSamplingLCE<reverseArcDirection>::rerun()
    {
#ifdef COLLECT_PR_DATA
        reruns++;
#endif
    ...
    template <bool reverseArcDirection>
    DiGraph::size_type SimpleESTreeReservoirSamplingLCE<reverseArcDirection>::process(SESVertexData *vd, bool &limitReached)
    {
    ...
    template <bool reverseArcDirection>
    void SimpleESTreeReservoirSamplingLCE<reverseArcDirection>::restoreTree(SESVertexData *rd)
    {
        auto n = diGraph->getSize();
    ...
    template <bool reverseArcDirection>
    void SimpleESTreeReservoirSamplingLCE<reverseArcDirection>::cleanup(bool freeSpace)
    {
        if (initialized)
        {
            for (auto i = data.cbegin(); i != data.cend(); i++)
    ...
    template class SimpleESTreeReservoirSamplingLCE<false>;
    template class SimpleESTreeReservoirSamplingLCE<true>;
}
