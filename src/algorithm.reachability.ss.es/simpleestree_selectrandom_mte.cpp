...
#include "simpleestree_selectrandom_mte.h"
...
SimpleESTreeSelectRandomMTE<reverseArcDirection>::SimpleESTreeSelectRandomMTE(unsigned int requeueLimit, double maxAffectedRatio)
    : SimpleESTreeSelectRandomMTE<reverseArcDirection>(std::make_pair(requeueLimit, maxAffectedRatio))
{ }

template<bool reverseArcDirection>
SimpleESTreeSelectRandomMTE<reverseArcDirection>::SimpleESTreeSelectRandomMTE(const SimpleESTreeSelectRandomMTE<reverseArcDirection>::ParameterSet &params)
...
template<bool reverseArcDirection>
SimpleESTreeSelectRandomMTE<reverseArcDirection>::~SimpleESTreeSelectRandomMTE()
{
    cleanup(true);
}

template<bool reverseArcDirection>
DiGraph::size_type SimpleESTreeSelectRandomMTE<reverseArcDirection>::getDepthOfBFSTree() const
{
...
template<bool reverseArcDirection>
DiGraph::size_type SimpleESTreeSelectRandomMTE<reverseArcDirection>::getNumReachable() const
{
...
template<bool reverseArcDirection>
void SimpleESTreeSelectRandomMTE<reverseArcDirection>::run()
{
    if (initialized) {
        return;
    }

    PRINT_DEBUG("Initializing SimpleESTreeSelectRandomMTE...");
...
template<bool reverseArcDirection>
std::string SimpleESTreeSelectRandomMTE<reverseArcDirection>::getProfilingInfo() const
{
    std::stringstream ss;
#ifdef COLLECT_PR_DATA
...
template<bool reverseArcDirection>
DynamicSingleSourceReachabilityAlgorithm::Profile SimpleESTreeSelectRandomMTE<reverseArcDirection>::getProfile() const
{
...
template<bool reverseArcDirection>
void SimpleESTreeSelectRandomMTE<reverseArcDirection>::onDiGraphSet()
{
...
template<bool reverseArcDirection>
void SimpleESTreeSelectRandomMTE<reverseArcDirection>::onDiGraphUnset()
{
...
template<bool reverseArcDirection>
void SimpleESTreeSelectRandomMTE<reverseArcDirection>::onVertexAdd(Vertex *v)
{
    if (!initialized) {
        return;
    }
...
template<bool reverseArcDirection>
void SimpleESTreeSelectRandomMTE<reverseArcDirection>::onArcAdd(Arc *a)
{
    if (!initialized) {
        return;
    }
...
template<bool reverseArcDirection>
void SimpleESTreeSelectRandomMTE<reverseArcDirection>::onVertexRemove(Vertex *v)
{
    if (!initialized) {
        return;
    }
...
template<bool reverseArcDirection>
void SimpleESTreeSelectRandomMTE<reverseArcDirection>::onArcRemove(Arc *a)
{
   if (!initialized) {
        return;
    }
...
template<bool reverseArcDirection>
void SimpleESTreeSelectRandomMTE<reverseArcDirection>::onSourceSet()
{
    cleanup(false);
}

template<bool reverseArcDirection>
bool SimpleESTreeSelectRandomMTE<reverseArcDirection>::query(const Vertex *t)
{
...
template<bool reverseArcDirection>
std::vector<Arc *> SimpleESTreeSelectRandomMTE<reverseArcDirection>::queryPath(const Vertex *t)
{
    std::vector<Arc*> path;
    if (!query(t) || t == source) {
        return path;
...
template<bool reverseArcDirection>
void SimpleESTreeSelectRandomMTE<reverseArcDirection>::dumpData(std::ostream &os) const
{
    if (!initialized) {
...
template<bool reverseArcDirection>
void SimpleESTreeSelectRandomMTE<reverseArcDirection>::dumpTree(std::ostream &os)
{
    if (!initialized) {
        os << "uninitialized" << std::endl;
    }  else {
...
template<bool reverseArcDirection>
bool SimpleESTreeSelectRandomMTE<reverseArcDirection>::checkTree()
{
...
template<bool reverseArcDirection>
void SimpleESTreeSelectRandomMTE<reverseArcDirection>::rerun()
{
#ifdef COLLECT_PR_DATA
    reruns++;
#endif
...
template<bool reverseArcDirection>
DiGraph::size_type SimpleESTreeSelectRandomMTE<reverseArcDirection>::process(SESVertexData *vd, bool &limitReached) {
...
template<bool reverseArcDirection>
void SimpleESTreeSelectRandomMTE<reverseArcDirection>::restoreTree(SESVertexData *rd)
{
    auto n = diGraph->getSize();
...
template<bool reverseArcDirection>
void SimpleESTreeSelectRandomMTE<reverseArcDirection>::cleanup(bool freeSpace)
{
    if (initialized) {
        for (auto i = data.cbegin(); i != data.cend(); i++) {
            if ((*i)) {
...
template<bool reverseArcDirection>
std::pair<Arc*, SESVertexData*> SimpleESTreeSelectRandomMTE<reverseArcDirection>::selectRandomTreeArc(const ArcPool& potentialTreeArcs)
{
    const size_t arcIndex = generateRandomNumber() % potentialTreeArcs.size();
    return potentialTreeArcs.at(arcIndex);
}

template class SimpleESTreeSelectRandomMTE<false>;
template class SimpleESTreeSelectRandomMTE<true>;
}
